...
const buildPrompt = (profile: UserProfile): string => {
    return `
        ...
        **User Profile:**
        ...
        Your response must be a JSON object that strictly adheres to the provided schema. Ensure the reasoning for each career suggestion clearly connects back to the user's provided information.
    `;
};
